...
import { ClassManagerOptions, Target } from "../types.js";

export function parseOptions(
    obj: { [prop: string]: any } | ClassManagerOptions
) {
    const opt: ClassManagerOptions = {
        target: Target.Self,
    };
...
export function setOptions(
    this: ClassManager,
    options: ClassManagerOptions | { [prop: string]: any }
) {
