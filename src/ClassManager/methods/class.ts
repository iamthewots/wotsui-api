...
import { Method, ClassManagerOptions, Target } from "../types.js";

export function add(
    this: ClassManager,
    className: string,
    options?: ClassManagerOptions
) {
...
function shouldIgnoreInterval(method: Method, opt: ClassManagerOptions) {
...
function getTimeToWait(i: number, opt: ClassManagerOptions) {
